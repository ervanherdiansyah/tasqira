        ...
        try {
            ...
            if ($request->ajax()) {
                ...
                if ($request->has('order')) {
                    ...
                    if ($column == 'keuntungan') {
                        // Pastikan ini sesuai dengan kolom database Anda
                        $data->orderBy(DB::raw('CAST(REPLACE(REPLACE(keuntungan, "Rp. ", ""), ".", "") AS UNSIGNED)'), $direction);
                    } else if ($column == 'tanggal_order' || $column == 'deadline') {
                ...
                return DataTables::of($data)
                    ...
                    ->addColumn('item_belanja', function ($data) {
                        return $data->item_belanja ?: '-';
                    })
                    ->addColumn('sisa_bahan', function ($data) {
                        return $data->sisa_bahan ?: '-';
                    })
